// This file includes common data structures that are used for communication between the proxy and control_ui.
#pragma once
#include "helper.h"
#include "time_helper.h"

const u16 port = 60123;
...
// This defines the monitored ODrive axes. If you want to monitor multiple ODrives, you can adjust these
// values with minimal changes.
